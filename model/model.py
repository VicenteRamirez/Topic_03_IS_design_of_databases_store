...
class Model:
    ...
    ***************
    ...
    def read_a_zip(self, zip):
        try:
            ...
            vals = (zip,) # Se le pone ',' para indicar que es una tupla
    ...
    ***************************
    """
    def create_order_details(self, id_order, id_product, od_amount, od_total):
        try:
    ...
    def read_a_order_details(self, id_order):
        try:
